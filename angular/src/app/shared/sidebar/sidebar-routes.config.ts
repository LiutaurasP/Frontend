...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/about', title: 'About', icon: 'ft-home', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
...
//    { path: '/oracle', title: 'Oracle', icon: 'ft-aperture', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    ...
    { path: '/news', title: 'News', icon: 'ft-layout', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
//    { path: '/refreshes', title: 'Refreshes', icon: 'ft-shuffle', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
